...
{
	// If MyProject6 is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in MyProject6.Build.cs is not automatically propagated
